<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="图书名称" prop="xiaoshuomingcheng">
          <el-input v-model="ruleForm.xiaoshuomingcheng" 
              placeholder="图书名称" clearable  :readonly="ro.xiaoshuomingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="图书名称" prop="xiaoshuomingcheng">
              <el-input v-model="ruleForm.xiaoshuomingcheng" 
                placeholder="图书名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="图书类别" prop="xiaoshuoleibie">
          <el-select v-model="ruleForm.xiaoshuoleibie" placeholder="请选择图书类别">
            <el-option
                v-for="(item,index) in xiaoshuoleibieOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="图书类别" prop="xiaoshuoleibie">
	      <el-input v-model="ruleForm.xiaoshuoleibie"
          ...
          <el-form-item class="input" label="字数" prop="zishu">
              <el-input v-model="ruleForm.zishu" 
                placeholder="字数" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="热度" prop="redu">
          <el-input v-model="ruleForm.redu" 
              placeholder="热度" clearable  :readonly="ro.redu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="热度" prop="redu">
              <el-input v-model="ruleForm.redu" 
          ...
          <el-form-item class="input" label="价格" prop="price">
              <el-input v-model="ruleForm.price" 
                placeholder="价格" readonly></el-input>
                                                                                              ...
                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="总章节" prop="zongzhangjie">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="总章节"
                  v-model="ruleForm.zongzhangjie" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zongzhangjie" label="总章节" prop="zongzhangjie">
                    <span>{{ruleForm.zongzhangjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.neirong = this.ruleForm.neirong.replace(reg,'../../../ssm7rx43/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `remenpaixing/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.remenpaixingCrossAddOrUpdateFlag = false;
                  this.parent.search();
