<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="图书编号" prop="xiaoshuobianhao">
            <el-input v-model="ruleForm.xiaoshuobianhao" 
                placeholder="图书编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xiaoshuobianhao" label="图书编号" prop="xiaoshuobianhao">
              <el-input v-model="ruleForm.xiaoshuobianhao" 
                placeholder="图书编号" readonly></el-input>
          </el-form-item>
        </div>
